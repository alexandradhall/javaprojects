        ...
        do {
            do {    /* Begin internal do loop */
                ...
                try {   /* Try/Catch block beginning */
                    ...
                    errCall();  /* Call error message */ //Error 13? - edit errCall to work properly
            ...
            do {    /* Begin internal do loop */
                ...
                try {   /* Try/Catch block beginning */
                    ...
                    if (prev > curr)/*error 4- defined prev with initial variable*/ {  /* Check for previous reading < current reading */
                    ...
                    System.err.printf("Exception: %s\n", IME); /*Error 5- ;*/
                    errCall();  /* Call error message */ //Error 14?- Edit errCall to work properly.
                    sc.nextLine();  /* Clear buffer */
                    flag1 = true;
                }   /* End Try/Catch block */
            ...
            myCalcs.setUsage();
            System.out.printf("Your usage was: %.1fKwHs\n", myCalcs.getUsage()); /*Error 7- changed return type in MyCalcs, Error 9 changed type of print statement*/
            ...
            do {
                ...
                if (!(ans.equalsIgnoreCase("Y") || ans.equalsIgnoreCase("N"))) { //Error 19?- change equals to equalsIgnoreCase
                    YesNo = true;   /* reset incase of previous good run *///Error 17- added ending */ to comment
